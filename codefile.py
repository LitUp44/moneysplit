...
def calculate_complete_share(expenses, income1, income2):
    ...
    return total_percent, remaining, percent1, percent2, expense1, expense2
...
def calculate_proportional_expenses(expenses, income1, income2):
    ...
    expense1 = (percent1 / 100 * expenses) if total_income > 0 else 0
    expense2 = (percent2 / 100 * expenses) if total_income > 0 else 0
    share_bills1 = (expense1 / income1) * 100 if total_income > 0 else 0
    share_bills2 = (expense2 / income2) * 100 if total_income > 0 else 0
    remaining1 = income1 - expense1 if income1 > 0 else 0
    remaining2 = income2 - expense2 if income2 > 0 else 0
    return percent1, percent2, remaining1, remaining2, expense1, expense2, share_bills1, share_bills2
...
if st.session_state.calculated and income1 > 0 and income2 > 0 and expenses > 0:
    ...
    if option == '50/50 split':
        ...
        total_percent, remaining, percent1, percent2, expense1, expense2 = calculate_complete_share(expenses, income1, income2)
        expenses_data = {
        ...
        percent1, percent2, remaining1, remaining2, expense1, expense2, share_bills1, share_bills2 = calculate_proportional_expenses(expenses, income1, income2)
        expenses_data = {
